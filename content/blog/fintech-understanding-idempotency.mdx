...
thumbnail: "/blog/thumbnail_understanding-idempotency.png"
---
...
> **Idempotency** is about guaranteeing **consistency**. The system might still return a "Success" response for retries, but behind the scenes, it won't deduct the user's balance a second time.
...
![Sequence Diagram Flow Implementation Idempotency Key](/blog/seq-diagram-idempotency.png)
